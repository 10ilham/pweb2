                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                            <span class="badge bg-warning"><a href="edit_dsn.php?id=<?php echo $x['id']; ?>&aksi=edit">Edit</a></span>
                            <span class="badge bg-danger"><a href="proses_dsn.php?id=<?php echo $x['id']; ?>&aksi=hapus">Hapus</a></span>
                            </td>
                        </tr>
                    <?php
                    }
